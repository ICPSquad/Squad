...
export type CanisterLogRequest = { getMessagesInfo: null } | { getMessages: GetLogMessagesParameters } | { getLatestMessages: GetLatestLogMessagesParameters };
...
export type CommonError__1 = { InvalidToken: TokenIdentifier__1 } | { Other: string };
export type CommonError__2 = { InvalidToken: TokenIdentifier__1 } | { Other: string };
...
export type DetailsResponse =
  ...
  | { err: CommonError__2 };
export type Disbursement = [TokenIndex__1, AccountIdentifier__1, SubAccount__1, bigint];
...
export interface ICPSquadNFT {
  ...
  get_avatar_equipped: ActorMethod<[TokenIdentifier], [] | [TokenIdentifier]>;
  get_items: ActorMethod<[], Array<[string, Array<TokenIndex>]>>;
  get_materials: ActorMethod<[Principal, boolean], Array<[TokenIndex, string]>>;
  ...
  lock: ActorMethod<[TokenIdentifier, bigint, AccountIdentifier__2, Array<number>], LockResponse>;
...
export type ItemInventory = { Accessory: AccessoryInventory } | { Material: MaterialInventory };
...
export type LockResponse = { ok: AccountIdentifier__1 } | { err: CommonError__2 };
...
export type TransferResponse =
  | { ok: Balance }
  | {
      err: { CannotNotify: AccountIdentifier } | { InsufficientBalance: null } | { InvalidToken: TokenIdentifier__1 } | { Rejected: null } | { Unauthorized: AccountIdentifier } | { Other: string };
    };

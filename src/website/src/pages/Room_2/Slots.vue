  ...
  <div class="flex flex-col mb-8">
    <div class="flex flex-row justify-around flex-wrap">
      ...
      <div class="flex flex-col items-center">
        ...
        <button :class="showButton('Face') ? 'cursor-pointer bg-pink-600' : 'invisible'" class="lg:text-3xl md:text-2xl text-xl text-white rounded py-4 px-4 mt-4" @click="showButton ? removeSlot('Face') : null">Remove</button>
      </div>
    </div>
    <div class="flex flex-row justify-around flex-wrap">
      <div class="flex flex-col items-center">

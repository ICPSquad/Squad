<template>
    ...
    <div class="flex flex-col flex-1 h-full justify-around">
      ...
      >
        ...
        >
          ...
          <div class="w-40 lg:w-64">
            ...
            >
              ...
              >
                <g
                  id="ic_fluent_team_add_24_regular"
                  fill="#212121"
                  fill-rule="nonzero"
                >
                  <path
          ...
          >
            ...
            <span
              class="font-extrabold text-purple-500 cursor-pointer"
              @click="messageFee"
            >
              fee</span
            >.
        ...
        >
          ...
          <div class="w-40 lg:w-64">
            <img
              src="others/characters/Miss.svg"
              alt="Miss"
              class="rounded-2xl"
            />
          </div>
        ...
        >
          ...
          >
            ...
            <a
              href="https://www.dfinitycommunity.com/why-icp-squad-nfts-are-game-changer-for-internet-computer-dapps/"
              target="_blank"
              class="text-purple-500 font-extrabold"
            >
              rewards 💰
            </a>
            <br />
  ...
  >
    ...
    >
      <div>
        <div class="mb-4">
          <label
            class="lg:text-4xl md:text-3xl text-2xl text-white mb-8 mr-8"
            for="email"
          >
            Email Address 📬</label
          >
      ...
      <div class="mb-4">
        <div>
          <label class="lg:text-4xl md:text-3xl text-2xl text-white mb-8 mr-6">
            Twitter (or WeChat ID) 🐥</label
          >
        </div>
      ...
      <div>
        <div class="mb-4">
          <label class="lg:text-4xl md:text-3xl text-2xl text-white mb-8 mr-4">
        ...
        <div class="flex flex-row mt-8 justify-center">
          <label class="lg:text-2xl md:text-xl text-base text-white my-4 mr-4">
            Enter the text in this image</label
          >
        </div>
        <div>
      ...
      <h3
        ...
        "
      >
        🚨 <strong>Only 1 entry allowed per person.</strong><br />There's no
        gameplay advantage to owning more than one character. Cheaters risk
        being banned from the game.<br />
      </h3>
      <button
        class="
          2xl:text-5xl
      ...
      >
        ...
        The Internet Computer is still a new technology and NFT markets are
        unpredictable. The last thing we want is to have any of our dear
        supporters experience financial hardship due to unexpected delays or
        unpredictable market outcomes. Always do your own research and take
        accountability for managing your financial risk wisely. By submitting
        this form you agree to indemnify and hold ICP Squad harmless to the
        maximum extent permitted by applicable law, without limitation, from and
        against any and all losses. In other words, please don't try to sue us.
        We are just a bunch of nerds volunteering to build cool stuff for the
        Internet Computer, and a lawsuit would ruin all the fun.<br />
      </h3>
      <h3
        class="
          mb-2
        ...
        "
      >
        Having trouble submitting the form?<br />
      </h3>
      <a
        class="
          mb-24
          ...
          text-center
        "
        href="https://discord.com/invite/icpsquad"
        target="_blank"
      >
  ...
  <div
    ...
    "
  >
    <h1 class="text-center md:mb-16 mt-8 mb-8 font-marker">
      Congratulation 🎉
    </h1>
    <h3
      class="
      ...
      "
    >
      You've successfully joined the squad!<br />
    </h3>
    <div class="w-full flex flex-row justify-around items-center">
      <router-link to="/">
        <button
  ...
  setup() {
    ...
    const verification = () => {
      ...
      if (!email.value || !twitter.value || !discord.value) {
        if (
          !confirm(
            "You haven't filled all the fields, it's not mandatory but it's recommended for a better experience. \nDo you want to continue anyway?"
          )
        ) {
          return;
        }

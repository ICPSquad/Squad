<template>
  <div class="flex flex-col flex-1" v-if="status === 'disconnected'">
  ...
  <div v-else-if="status == 'member'" class="flex flex-col flex-1 w-full bg-gradient-to-l from-gray-600 via-gray-900 to-black lg:text-6xl md:text-4xl text-2xl font-semibold text-white justify-around">

  ...
  <div class="flex flex-col">
    ...
    <div class="mx-auto my-8">
      <select
        name="accessoryType"
        id="accessoryType"
        class="shadow-xl text-2xl px-6 py-4 text-gray-800 bg-pink font-bold"
        @change="changePicker"
      >
    ...
    <div
      ...
      v-if="accessoriesFiltered.length > 0"
    >
      <accessory-lab
        v-for="accessory in accessoriesFiltered"
        :key="accessory.name"
        :description="accessory.description"
        :name="accessory.name"
        :recipe="accessory.blueprint"
      ></accessory-lab>
    </div>
    <div v-else>
      <h3

...
export const idlFactory: IDL.InterfaceFactory = ({ IDL }) => {
  ...
  const Invoice = IDL.Service({
    ...
    accountIdentifierToBlob: IDL.Func([AccountIdentifier__1], [AccountIdentifierToBlobResult], []),
    ...
    get_account_identifier: IDL.Func([GetAccountIdentifierArgs], [GetAccountIdentifierResult], ["query"]),
    ...
    verify_invoice_accessory: IDL.Func([VerifyInvoiceArgs], [VerifyInvoiceResult], []),
    verify_invoice_avatar: IDL.Func([VerifyInvoiceArgs, IDL.Principal], [VerifyInvoiceResult], []),
  });
  return Invoice;
};

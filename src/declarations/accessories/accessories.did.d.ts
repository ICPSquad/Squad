...
export interface ICPSquadNFT {
  ...
  'addElements' : (arg_0: string, arg_1: Template) => Promise<Result_6>,
  ...
  'bearer' : (arg_0: TokenIdentifier__2) => Promise<Result_4>,
  'burn' : (arg_0: TokenIdentifier__2) => Promise<Result>,
  ...
  'delete' : (arg_0: string) => Promise<Result__1>,
  ...
  'metadata' : (arg_0: TokenIdentifier__2) => Promise<Result_3>,
...
export type Result_4 = { 'ok' : AccountIdentifier__2 } |
  { 'err' : CommonError };
export type Result_5 = { 'ok' : TokenIdentifier__2 } |
  { 'err' : string };

export const idlFactory = ({ IDL }) => {
  ...
  const ICPSquadNFT = IDL.Service({
    ...
    check_avatar_infos: IDL.Func([IDL.Principal], [IDL.Opt(TokenIdentifier), IDL.Opt(AvatarRendering)], ["query"]),
    ...
    get_all_users: IDL.Func([], [IDL.Vec(IDL.Tuple(IDL.Principal, UserData))], []),
    get_avatar_infos: IDL.Func([], [IDL.Opt(TokenIdentifier), IDL.Opt(AvatarRendering)], ["query"]),
    get_infos_holders: IDL.Func([], [IDL.Vec(IDL.Tuple(IDL.Principal, IDL.Opt(AccountIdentifier__1), IDL.Opt(IDL.Text), IDL.Opt(IDL.Text), IDL.Opt(TokenIdentifier)))], ["query"]),
    get_infos_leaderboard: IDL.Func([], [IDL.Vec(IDL.Tuple(IDL.Principal, IDL.Opt(Name__2), IDL.Opt(TokenIdentifier)))], ["query"]),
    get_number_users: IDL.Func([], [IDL.Nat], ["query"]),
    get_style_score: IDL.Func([], [IDL.Vec(IDL.Tuple(TokenIdentifier, StyleScore))], ["query"]),
    ...
    removeAccessory: IDL.Func([TokenIdentifier, IDL.Text, IDL.Principal], [Result], []),
    report_burned_accessory: IDL.Func([IDL.Text, TokenIdentifier, TokenIndex], [], []),
    ...
    wearAccessory: IDL.Func([TokenIdentifier, IDL.Text, IDL.Principal], [Result], []),
  });
  return ICPSquadNFT;
};
